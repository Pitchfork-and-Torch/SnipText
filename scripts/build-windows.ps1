...
2. Hotkey default: Ctrl+Shift+T (snip), Ctrl+Shift+R (replay), Ctrl+Shift+I (clipboard image)
...
6. A camera shutter plays when a screen snip is captured (Settings can mute it)
7. Read clipboard image and Read image file do not write the picture into app data
8. Keep the whole SnipText\ folder together (onedir build)

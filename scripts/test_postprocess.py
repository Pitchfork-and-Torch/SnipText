...
from sniptext.transcribe.postprocess import maybe_plain, shape_output
...
def main() -> None:
    ...
    assert shape_output("keep *this*", "markdown") == "keep *this*"
    assert shape_output("alpha\n\nbeta", "line") == "alpha beta"
    assert shape_output("weird", "nope") == "weird"

...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "replay_hotkey": "ctrl+shift+r" if platform.system() != "Darwin" else "cmd+shift+r",
    "clipboard_hotkey": "ctrl+shift+i" if platform.system() != "Darwin" else "cmd+shift+i",
    "engine_mode": "ai_first",  # ai_first | local_only | ai_only
    "vision_model": "grok-4.5",
    "vision_detail": "high",
    "output_format": "markdown",  # markdown | plain | line
    "languages": ["en"],

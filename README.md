...
[![Version](https://img.shields.io/badge/version-1.3.1-5BDBFF)](https://github.com/Pitchfork-and-Torch/SnipText/releases/latest)
...
**Current package: v1.3.1 Replay** (replay last region hotkey; pinned Clip Desk items survive overflow)
